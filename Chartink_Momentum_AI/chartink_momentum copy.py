...
condition = {
    ...
    ( {cash} (
        ( {cash} (
            latest close > latest ema( latest close , 9 )
            and 1 day ago close <= 1 day ago ema( latest close , 9 )
            and latest ema( latest close , 10 ) >= latest ema( latest close , 20 )
            and latest ema( latest close , 20 ) >= latest ema( latest close , 50 )
            and latest ema( latest close , 50 ) >= latest ema( latest close , 200 )
        ...
        ( {cash} (
            latest close > latest ema( latest close , 20 )
            and 1 day ago close <= 1 day ago ema( latest close , 20 )
            and latest ema( latest close , 50 ) >= latest ema( latest close , 200 )
            and latest ema( latest close , 20 ) >= latest ema( latest close , 50 )
            and market cap > 2000
            and latest close >= 1 day ago high
